...
export const MOCK_ACTIVITY = [
  { type: "Buy", symbol: "AAPL", date: "Today, 10:23 AM", amount: "-$1,250.00", status: "Completed" },
  { type: "Sell", symbol: "TSLA", date: "Yesterday, 2:45 PM", amount: "+$4,200.00", status: "Completed" },
];